      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body">
              <form method="post" action="{{ url('/')}}/casenumbers/invoice/search">
              {{ csrf_field() }}
              <div class="col-md-4">
                ...
                <div class="form-group">
                  <a class="btn btn-info" href="{{url('/')}}/casenumbers/expenses/add">Add Expenses</a>
                ...
                <tbody>
                  ...
                  @foreach ( $invoices as $key => $value )
                    ...
                    <tr>
                      ...
                      <td>{{ $value->user_name->name }}</td>
                      <td><a class="btn btn-info" href="{{ url('/') }}/casenumbers/case/show/{{ $value->cases->id }}">Detail</a></td>
                    </tr>
                    @php $i++;@endphp 
                    @endif
                  @endforeach
